...
|--------|:-:|:-:|---|
| **Finance** | 14 | 133 | SEC/10-K, financial statements, valuation, ratios |
...
2. **Synonym expansion**: Domain-specific vocabulary resolution (1,909 terms across 7 domains)
...
domains/                   # Domain plugin package
  ...
  finance.py               # 14 synonym groups, 133 terms
